    ...
    <body>
        <div class="containe-parent-body">
            ...
            <div class="containe-child2-body" align="center" >
                <h1 style="padding-top: 20px;">Usuario Registrado con exito</h1>
            </div>
            <div class="containe-child3-body" align="center">
                <button class="btn btn-primary" onclick="window.location='${pageContext.request.contextPath}/login.jsp'"> Ingresar </button>
            </div>
        </div>
    </body>
</html>