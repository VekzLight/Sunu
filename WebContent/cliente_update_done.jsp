...
<html>
    <head>
        <title>Modificacon Fallida</title>
    </head>
    ...
    <body>
        <div class="containe-parent-body">
            ...
            <div class="containe-child2-body" align="center" >
                <h1 style="padding-top: 20px;">Usuario Modificado Con Exito</h1>
            </div>
            <div class="containe-child3-body" align="center">
                <button class="btn btn-primary" onclick="window.location='${pageContext.request.contextPath}/ClienteForm'"> Regresar </button>
            </div>
        </div>
    </body>
</html>