    ...
    <body>
        <div class="containe-parent-body2">
            ...
            <div align="right" style="margin: 20px;">
                <p>Descargar detallada</p> 
                <input class="btn btn-primary" value="HTML" type="button" onclick="window.location='ClienteFormHtml?llave=${cliente.id}'"> 
                <input class="btn btn-primary" value="PDF"  type="button" onclick="window.location='ClienteFormPdf?llave=${cliente.id}'">
                <input class="btn btn-primary" value="XLS"  type="button" onclick="window.location='ClienteFormXls?llave=${cliente.id}'">
            </div>
                <form method="post" action="<%=request.getContextPath()%>/ClienteUpdate" id="formularioInicio">
