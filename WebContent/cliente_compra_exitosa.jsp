    ...
    <body>
        <div class="containe-parent-body">
            ...
            <div class="containe-child2-body" align="center" >
                <h1 style="padding-top: 20px;">Compra Realizada  Con Exito</h1>
            </div>
            <div class="containe-child3-body" align="center">
                <button class="btn btn-primary" onclick="window.location='${pageContext.request.contextPath}/ProductoSelectClienteForm'"> Regresar </button>
            </div>
        </div>
    </body>
</html>