...
public class ProductoInsertServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * Default constructor.
     */
    public ProductoInsertServlet() {
    ...
    private void updateProducto(Connection connection, ProductoDTO producto)
        ...
        PreparedStatement statement = connection.prepareStatement("INSERT INTO producto "
            + "VALUES(null, ?,1,?,?,\"none\");");
        try {
