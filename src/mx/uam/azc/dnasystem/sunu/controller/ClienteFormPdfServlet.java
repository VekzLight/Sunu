...
public class ClienteFormPdfServlet extends HttpServlet {
    ...
    private ClienteDTO getCliente(int key, HttpServletResponse response) throws NamingException, SQLException, IOException, DocumentException{
    ...
    private ClienteDTO getCliente(Connection connection, int key, HttpServletResponse response) throws SQLException, IOException, DocumentException{
      ...
      try {
          ...
          documentShow(cliente, response, key);
