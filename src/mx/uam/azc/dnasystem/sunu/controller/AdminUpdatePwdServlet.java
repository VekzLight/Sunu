...
@WebServlet(name = "AdminUpdatePwd", urlPatterns = { "/AdminUpdatePwd" })
...
public class AdminUpdatePwdServlet extends HttpServlet {
	...
	*/
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String usuario = request.getSession().getAttribute( "Admin" ).toString();
        ...
        try {
            ...
            if(i > 0) {
                ...
                response.sendRedirect(base + "/admin_update_done.jsp");
            } else {
                String base = request.getContextPath();
                response.sendRedirect(base + "/admin_update_fail.jsp");
            }
        }
        catch(Exception se) {
            se.printStackTrace();
